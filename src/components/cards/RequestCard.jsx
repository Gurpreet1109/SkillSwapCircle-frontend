...
const RequestCard = ({
  ...
  const isReceiver =
    request.reciever?._id === currentUserId ||
    request.reciever === currentUserId;
  const isSender =
    request.sender?._id === currentUserId || request.sender === currentUserId;
  const other = isReceiver
    ? request.sender?.name || "User"
    : request.reciever?.name || "User";
  ...
  return (
    <div className="glass-card p-3">
      ...
      >
        ...
        >
          <p
            style={{ margin: 0, fontSize: "0.65rem", color: "var(--text-dim)" }}
          >
            Offered
          </p>
        ...
        <span style={{ color: "var(--primary-light)", fontSize: "1.2rem" }}>
          ⇄
        </span>
        <div
          style={{
